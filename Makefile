...
.additions:
	-@docker rm /yamsergey/bb10-ndk:0.5.1 /yam_additions 2> /dev/null
	...
	docker run -it --name yam_add2 yamsergey/bb10-ndk:0.5.2 bash -c "apt-get update ; apt-get -yq install vi lua52"
